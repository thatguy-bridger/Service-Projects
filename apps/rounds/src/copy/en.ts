...
export const en = {
  ...
  "signup.address.subtitle": "Type your address — we'll place an approximate pin on the map. Drag it if it's not quite right.",
  "signup.address.label": "Street address",
  "signup.address.placeholder": "123 Main St",
  "signup.address.zone": "City or ZIP",
  "signup.address.zonePlaceholder": "Sandy, UT",
  "signup.address.locating": "Locating…",
  "signup.address.approxPin": "Approximate location found ({{confidence}}% confidence). Drag the pin if it's off.",
  "signup.address.pinAt": "Pin is at: {{address}}",
  "signup.address.noPin": "We couldn't place a pin automatically — continue and a volunteer will confirm in person.",
